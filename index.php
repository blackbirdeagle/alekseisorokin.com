            ...
            <div class = "col-md-12">
                <div class = "about__social">
                    <div class = "social">
                        ...
                        <a class = "lang__version" href = "/en/">English version</a>
                    </div>
                </div>
            </div>
        </div>-->
...
<section id = "services" class = "services">
    <div class = "container">
        <div class = "row">
            ...
            <div class = "col-md-6">
				<?php echo do_shortcode( '[servicesrulist]' ); ?>
            </div>
        </div>
    </div>
</section>
...
<section id = "foto" class = "foto">
	...
	<?php echo do_shortcode( '[fotorulist]' ); ?>
...
<section id = "video" class = "video">
    <div class = "container">
        <div class = "row">
            <div class = "col-md-12">
                <p class = "video__head">Видео</p>
            </div>
        </div>
    </div>
<?php echo do_shortcode( '[videorulist]' ); ?>	
</section>
